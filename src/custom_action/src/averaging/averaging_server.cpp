...
using ActionServer = actionlib::SimpleActionServer<custom_action::AveragingAction>;
...
protected:
  ...
  float sum_, sum_sq_;
  custom_action::AveragingFeedback feedback_;
  custom_action::AveragingResult result_;
