...
using ActionServer = actionlib::SimpleActionServer<custom_action::FactorialAction>;
...
class FactorialAction {
  protected:
    ...
    custom_action::FactorialFeedback action_feedback_;
    custom_action::FactorialResult action_result_;
  ...
  void execute_callback(const custom_action::FactorialGoalConstPtr &goal) {
    ros::Rate r(50);
    bool success = true;
